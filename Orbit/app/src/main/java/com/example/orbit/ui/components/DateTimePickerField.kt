...
fun DateTimePickerField(
    ...
    Column(modifier = modifier, verticalArrangement = Arrangement.spacedBy(4.dp)) {
        ...
        PickerRow(
            ...
            label = stringResource(R.string.create_field_start),
            value = value?.let { formatEventDateTime(it) },
            placeholder = stringResource(R.string.datetime_pick),
            accent = accent,
        ...
        AlertDialog(
            ...
            text = {
                Row(
                    ...
                    // Unos brojeva umesto brojcanika; tacno vreme se kuca brze nego sto se pogadja
